...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    common_vendor.index.__f__("log", "at pages/mine/user/mypost.vue:79", userinfo.expert_id);
    ...
    const click = (item, index) => {
      common_vendor.index.__f__("log", "at pages/mine/user/mypost.vue:88", item, index);
      current.value = index;
    };
    const option = common_vendor.ref();
    common_vendor.onLoad((options) => {
      option.value = options.expert_id;
      common_vendor.index.__f__("log", "at pages/mine/user/mypost.vue:95", "options.expert_id", option.value);
    ...
    const getKnowledge = (id) => {
      common_vendor.index.request({
        ...
        success(res) {
          var _a;
          common_vendor.index.__f__("log", "at pages/mine/user/mypost.vue:113", res.data);
        ...
        fail(err) {
          common_vendor.index.__f__("log", "at pages/mine/user/mypost.vue:119", err);
        }
      });
    };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-7d47437e"]]);
wx.createPage(MiniProgramPage);
//# sourceMappingURL=../../../../.sourcemap/mp-weixin/pages/mine/user/mypost.js.map

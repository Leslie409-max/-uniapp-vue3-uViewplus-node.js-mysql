...
// ../../../../HbuliderXlocalSave/Blueberry/node_modules/marked/lib/marked.esm.js
function M() {
...
` + r.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = o.text) : t.push(r);
  ...
  inlineTokens(e, t = []) {
    ...
    for (; e; ) {
      ...
      i || (o = ""), i = false;
      let a;
      if ((_d = (_c = this.options.extensions) == null ? void 0 : _c.inline) == null ? void 0 : _d.some((p) => (a = p.call({ lexer: this }, e, t)) ? (e = e.substring(a.raw.length), t.push(a), true) : false))
        continue;
